...
// Clear existing content in the book column
bookContainer.innerHTML = '';

// Loop through each article and create elements dynamically
articles.forEach(article => {
    // Create a new row for each book
    const bookRow = document.createElement('div');
    bookRow.classList.add('bookRow');

    // Create information elements for the left column
    ...
    infoDiv.innerHTML = `
        ...
        <p>${article.stars}</p>
    `;
    bookRow.appendChild(infoDiv); // Append info div to book row

    // Create book elements for the right column
    ...
    `;
    bookRow.appendChild(bookDiv); // Append book div to book row

    // Append the complete book row to the book column
